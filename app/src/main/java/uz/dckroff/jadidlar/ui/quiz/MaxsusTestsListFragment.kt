...
import uz.dckroff.jadidlar.databinding.FragmentMaxsusTestsListBinding
...
class MaxsusTestsListFragment : Fragment() {
    private var _binding: FragmentMaxsusTestsListBinding? = null
    private val binding get() = _binding!!
    private val viewModel: MaxsusTestsListViewModel by viewModels()
    ...
    override fun onCreateView(
        ...
        _binding = FragmentMaxsusTestsListBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupAdapter() {
        quizAdapter = QuizAdapter { test ->
            try {
                ...
                findNavController().navigate(R.id.action_maxsusTestsList_to_quizSession, bundle)
            } catch (e: Exception) {
            ...
            when (resource) {
                ...
                is Resource.Error -> {
                    ...
                    ErrorHandler.showErrorWithRetry(
                        requireContext(),
                        "Maxsus testlar ma'lumotlarini yuklashda xatolik",
